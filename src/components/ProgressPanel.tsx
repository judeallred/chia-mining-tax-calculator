      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-emerald-800">{phaseLabel}</span>
            {progress.fromCache && (
              <span className="text-xs rounded-full bg-emerald-200 px-2 py-0.5 text-emerald-700">
                Cached
              </span>
            )}
            {progress.retrying && (
          ...
          <p className="text-sm text-emerald-700 mt-0.5">{progress.message}</p>
          {progress.total > 1 && (
